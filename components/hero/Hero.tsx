    ...
    <section className="hero-section relative w-full h-full mb-28">
      <div className="hero-section flex flex-col  mb-10 md:mb-20">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-5 md:gap-10 lg:gap-3 xl:gap-10 md:h-auto">
          ...
          <div className="flex gap-2 w-full md:gap-10 lg:gap-3 xl:gap-10 xl:w-4/5">
          <Image src={heroImg2} alt="hero image" className="w-1/2 lg:w-60 xl:w-full h-auto rounded-2xl" />
          <Image src={heroImg3} alt="hero image" className="w-1/2  lg:w-60 xl:w-full h-auto rounded-2xl" />
