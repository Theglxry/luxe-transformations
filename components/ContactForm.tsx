          ...
          <form action="" className="space-y-5">
            <div className="flex gap-2 sm:gap-5 max-tablet:flex-col">
              <input
                ...
                className="btn-bg w-full p-2 sm:p-4 rounded-md focus:outline-none"
                required
              />
              <input
                type="text"
            ...
            <div className="flex flex-col md:flex-row gap-2 sm:gap-5 items-center justify-center">
              <textarea
                ...
                className="btn-bg w-full md:min-h-[200px] rounded-md px-6 py-3 text-base focus:outline-none"
              ></textarea>

              <button
                type="submit"
                className="regular red rounded-full w-[100px] h-[100px] md:w-[270px] md:h-[200px] flex items-center justify-center"
              >
                SUBMIT
              </button>
            </div>
